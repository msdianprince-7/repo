...
export default function Home() {
  ...
  const terminalLines = [
    { prompt: "priyanshnandwana@portfolio:~$", command: "whoami", output: "Priyansh Nandwana - Software Engineer" },
    { prompt: "priyanshnandwana@portfolio:~$", command: "cat about.txt", output: "Backend engineer specializing in Java, Spring Boot, AWS cloud infrastructure,\nand microservices architecture. Experienced in building scalable\nsystems processing 10,000+ transactions daily with 99.9% uptime." },
    { prompt: "priyanshnandwana@portfolio:~$", command: "ls skills/", output: "languages/    backend/    databases/    cloud/" },
    { prompt: "priyanshnandwana@portfolio:~$", command: "echo $CURRENTLY_WORKING_ON", output: '"Architecting AWS middleware at AGSuite Technologies"' },
    { prompt: "priyanshnandwana@portfolio:~$", command: "cat contact.json", output: '{\n  "email": "nandwana.priyansh103@gmail.com",\n  "github": "https://github.com/msdianprince-7",\n  "linkedin": "https://www.linkedin.com/in/priyansh-nandwana/"\n}' },
  ];
      ...
      <div className="bg-[#1e2127] rounded-lg shadow-2xl border border-[#181a1f] overflow-hidden">
        ...
        <div className="p-6 font-mono text-sm space-y-4 min-h-[500px]">
          ...
          {typedLines === terminalLines.length && (
            ...
            >
              <span className="text-[#98c379]">priyanshnandwana@portfolio:~$</span>
